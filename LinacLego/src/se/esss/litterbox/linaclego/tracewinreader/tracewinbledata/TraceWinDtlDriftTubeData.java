...
public class TraceWinDtlDriftTubeData extends TraceWinBleData
{
	...
	public TraceWinDtlDriftTubeData(String[] traceWinData, String comment, TraceWinCommandReader traceWinCommandReader) 
	{
	...
	@Override
	public String setLegoIdIndexLabel() {return "DRT-";}
	@Override
